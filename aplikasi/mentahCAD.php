...
if($semestercari<>''){
$sqlcari="SELECT * FROM mentah where idtempat='$idtempatcari' and tahun='$tahuncari' and semester='$semestercari' ";
}
}
...
document.getElementById('tahun').value = string[8];
document.getElementById('semester').value = string[9];
...
?> 
			...
			$s = mysql_query("SELECT * FROM tempat where id='$akses_tempat' order by tempat asc");
			 ...
			 <?php }}?>
									                                         ...
									                                         <select name="idkelurahan" id="kel" >
			 ...
			 <option  value="20">Sedang</option>
			  <option  value="10">Besar</option>
											...
											<div class="form-group">
                                               ...
                                               <select name="tahun" id="tahun" size="1" class="form-control">
											     <option selected="selected"  value="">.:: Tahun  ::.</option>
<?php
for($i=2015;$i<=date('Y');$i++){
if($i<10){ $i="0".$i; }
...
?>    
											...
											<div class="form-group">
                                               ...
                                               <select name="semester" id="semester" size="1" class="form-control">
											     <option selected="selected"  value="">.:: Semester  ::.</option>
												  <option  value="1">Semester I</option>
												  <option  value="2">Semester II</option>
